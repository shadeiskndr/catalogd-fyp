...
export const reviewCol = process.env.NEXT_PUBLIC_APPWRITE_REVIEW_COLLECTION!
export const messagesCol = process.env.NEXT_PUBLIC_APPWRITE_MESSAGES_COLLECTION!
