...
const Login = () => {
    ...
    try {
      if (isSignup) {
        ...
        await account
          ...
          .then(() => {
            account
              .createEmailSession(signupDetails.email, signupDetails.password)
              .then(() => {
  ...
  return (
    <div className="flex flex-shrink items-center justify-center">
      ...
      space-y-6 bg-red-200 p-8 rounded-3xl"
      >
        {/* Logo */}
        ...
        <div className="fixed top-0 left-0 w-screen h-screen bg-gray-800/20 bg-opacity-90 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            >
              ...
              />
              <button
                className="px-6 py-3 bg-[#5865f2] text-white rounded-lg shadow-lg hover:scale-110 transition-all duration-300 ease-in-out
               font-semibold"
                type="submit"
              >
                Send E-mail
