...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: the async CookieStore API is not available in Safari or Firefox, and this write must stay synchronous so the state survives the next navigation.
