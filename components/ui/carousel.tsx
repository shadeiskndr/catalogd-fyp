...
function CarouselItem({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: an APG carousel slide is a role="group" with aria-roledescription; a <fieldset> is a form construct and would be wrong here.
    <div
      role="group"
