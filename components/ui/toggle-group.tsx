...
function ToggleGroup({
  ...
  const groupContext = React.useMemo(() => ({ variant, size, spacing }), [variant, size, spacing]);
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      {...props}
    >
      <ToggleGroupContext.Provider value={groupContext}>{children}</ToggleGroupContext.Provider>
    </ToggleGroupPrimitive.Root>
  );
}
